...
1. [Exercise 00: Finding Things](#ex00)
2. [Exercise 01: Counting Things](#ex01)
3. [Exercise 02: Running Things](#ex02)
4. [Exercise 03: Archiving Things](#ex03)

<h2 id="ex00">Exercise 00: Finding Things</h2>
...
<h2 id="ex01">Exercise 01: Counting Things</h2>
...
Let's assume our files are utf-8 encoded text files, so your code should work with texts in Russian, too (forget about special cases like Arabic for now, only English and Russian are required). Also, you may ignore punctuation and just consider spaces as the only word delimiters.
...
<h2 id="ex02">Exercise 02: Running Things</h2>

[Xarg](https://shapeshed.com/unix-xargs/). Let's implement a similar tool - in this exercise you'll need to write a utility that will:
...
<h2 id="ex03">Exercise 03: Archiving Things</h2>
